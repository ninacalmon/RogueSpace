...
var pages := {
	0: {
		"left": {
			...
			"sketch": preload("res://Sprites_main/SpaceshipInterior/drawingTest.png")
		},
		"right": {
...
Amanhã devo coletar fragmentos extra para me preparar...",
			"sketch": preload("res://Sprites_main/SpaceshipInterior/drawing_day1_3.png")
		}
	},
...
Acho que estou pronto.",
			"sketch": preload("res://Sprites_main/SpaceshipInterior/drawing_day3.png")
		}
	},
...
Enfim darei sequência à expedição. [b]Sim! A fonte do sinal será encontrada.",
		...
		"right": {
			"main": "",
			"sketch": preload("res://Sprites_main/SpaceshipInterior/drawing_day4.png")
		}
	}
}
...
#
	#3: {
		...
		#"sketch": preload("res://Sprites_main/SpaceshipInterior/DesenhoDiario.png")
	#}
#}
#
